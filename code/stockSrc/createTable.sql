 ...
 *                                                                    *
 * Ce modèle est un modèle en diamant, à 4 tables                     *
 * ------------------------------------------------------------------ */
...
/* table matching :
		#id         : identifiant de chaque ligne
		_idSDSS     : id de la source dans la table srcSDSS
		_idSTACK    : id de la source dans la table srcSTACK
		_idAlgo     : id de l'algorithme de matching dans la table algorithms
*/
	`id` BIGINT NOT NULL AUTO_INCREMENT,
