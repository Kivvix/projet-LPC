...
%%TODO: parler de la RNG
On considère généralement que le générateur de nombres pseudo-aléatoires par défaut n'est pas bon\dots
% expliquer pourquoi, en quoi on considère qu'il n'est pas bon
% et parler rapidement du fait qu'il existe d'autres générateurs de nombres pseudo-aléatoires
% peut-être rajouter à un endroit pourquoi on parle de pseudo-aléatoire et pas d'aléatoire
